...
{
	int id = 1;
    DutyChart* obj = new DutyChart(1);//в зависимости от состо€ни€ редактировани€ запомнит ID

	//занести им€
	//запомнить €корную дату
	//запомнить платежную форму
	//в зависимости от платежной формы запомнить рабочее врем€
