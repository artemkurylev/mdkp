...
{
	QMessageBox::information(this, QString::fromWCharArray(L"–ежим тестировани€"), QString::fromWCharArray(L"Ѕобро поржаловать в\nрежим автоматического тестировани€ GUI!")); 
	...
	QMessageBox::information(this, QString::fromWCharArray(L"–ежим тестировани€"), QString::fromWCharArray(L"“естирование GUI завершено!\n оличество проваленных тестов: %1.").arg(r) ); 
