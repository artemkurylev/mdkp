...
public:
    ...
    void setupUi(QMainWindow *SalaryCount)
    {
        ...
        addDutyChart = new QPushButton(groupBox_4);
        ...
        gridLayout_6->addWidget(DutyChartMarksEdit, 0, 0, 1, 1);


        gridLayout_7->addWidget(dutyChartEdit, 0, 1, 1, 1);
